...
[![Artifact HUB](https://img.shields.io/endpoint?url=https://artifacthub.io/badge/repository/netdata)](https://artifacthub.io/packages/search?repo=netdata) ![Version: 3.6.2](https://img.shields.io/badge/Version-3.6.2-informational) ![AppVersion: v1.29.2](https://img.shields.io/badge/AppVersion-v1.29.2-informational)
...
| `image.tag`                              | Container image tag                                                                                                                                    | Latest stable netdata release (e.g. `v1.29.2`)                            |
