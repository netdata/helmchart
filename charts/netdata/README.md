...
<img loading="lazy" src="https://img.shields.io/badge/AppVersion-v2.2.1-informational" alt="AppVersion: v2.2.1" class="img_node_modules-@docusaurus-theme-classic-lib-theme-MDXComponents-Img-styles-module"></img>
