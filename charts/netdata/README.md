...
[![Artifact HUB](https://img.shields.io/endpoint?url=https://artifacthub.io/badge/repository/netdata)](https://artifacthub.io/packages/search?repo=netdata) ![Version: 3.7.15](https://img.shields.io/badge/Version-3.7.15-informational) ![AppVersion: v1.33.1](https://img.shields.io/badge/AppVersion-v1.33.1-informational)
...
| `child.livenessProbe.host`               | Host to run the probe against                                                                                                                          | `Not set (pod's IP)`                                                                    |
...
| `child.readinessProbe.host`              | Host to run the probe against                                                                                                                          | `Not set (pod's IP)`                                                                    |
