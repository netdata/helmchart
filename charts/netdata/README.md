...
<img loading="lazy" src="https://img.shields.io/badge/AppVersion-v2.2.3-informational" alt="AppVersion: v2.2.3" class="img_node_modules-@docusaurus-theme-classic-lib-theme-MDXComponents-Img-styles-module"></img>
