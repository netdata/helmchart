...
[![Artifact HUB](https://img.shields.io/endpoint?url=https://artifacthub.io/badge/repository/netdata)](https://artifacthub.io/packages/search?repo=netdata) ![Version: 3.7.19](https://img.shields.io/badge/Version-3.7.19-informational) ![AppVersion: v1.35.1](https://img.shields.io/badge/AppVersion-v1.35.1-informational)
...
| `k8sState.alarms.persistence`              | Whether should use a persistent volume for `/var/lib/netdata`                                                                                          | `true`                                                                                  |
| `k8sState.alarms.storageclass`             | The storage class for the persistent volume claim of  `/var/lib/netdata`                                                                               | the default storage class                                                               |
| `k8sState.alarms.volumesize`               | The storage space for the PVC of `/var/lib/netdata`                                                                                                    | `1Gi`                                                                                   |
