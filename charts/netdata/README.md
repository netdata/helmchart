...
| `child.persistence.rootDir`              | Host node directory for storing child instance data                                                                                                    | `/var/lib/k8s-netdata-child`                                              |
| `child.persistence.namespaceAware`       | Whether or not to append namespace value to the `child.persistence.rootDir`                                                                            | `false`                                                                   |
| `child.persistence.userID`               | Files owner numeric id. Must be equal to the netdata process user id.                                                                                  | `201`                                                                     |
| `child.persistence.varlib`               | Whether or not to persist `/var/lib/netdata` in the `child.persistence.rootDir`.                                                                       | `true`                                                                    |
